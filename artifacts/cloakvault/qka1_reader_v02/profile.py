...
_FIELDS = frozenset(
    {
        ...
        "training_partition_source_commit",
...
class ReaderProfile:
    ...
    training_partition_source_commit: str
    training_partition_sha256: str
    reader_code_commit: str
    ...
    def from_json_bytes(cls, raw: bytes) -> "ReaderProfile":
        ...
        return cls(
            ...
            training_partition_source_commit=_lower_hex(
                data["training_partition_source_commit"],
                40,
                "training_partition_source_commit",
            ),
            ...
            reader_code_commit=_lower_hex(
                data["reader_code_commit"], 40, "reader_code_commit"
            ),
        )
